# This was copied from the community.general GitHub repository, with
# changes to support simulated run_command for testing purposes. Those
# changes are more code than was in the file originally in
# community.general, so I've left Bojan Vitnik's original copyright in
# place and added my own superseding copyright for this new version.
